<template>
  <div class="text-slate-100" style="padding: 8px 16px;">
    <div v-if="size === 'small'" class="flex flex-col justify-center">
      ...
      <div class="text-xs text-blue-400">({{ data.topScorer.points }} pts)</div>
    </div>
    <div v-else-if="size === 'medium'" class="space-y-3">
      <div class="text-xs font-semibold text-white mb-2">Team Leaders</div>
    ...
    <div v-else class="space-y-2">
      <div class="text-xs font-bold text-white mb-3">Player Statistics</div>
